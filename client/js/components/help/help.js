	...
	render() {
		return (
			<section className="home-container">
				...
				<p>After calculating your TDEE, MacroCalculator asks for your fitness goals: lose weight, maintain weight, or gain weight.</p>
				<p>Based on your goals, MacroCalculator</p> 
			</section>
		);
	}
}
